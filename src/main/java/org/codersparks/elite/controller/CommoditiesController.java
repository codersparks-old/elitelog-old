...
public class CommoditiesController implements ResourceProcessor<RepositoryLinksResource> {
	...
	public HttpEntity<DistinctCommodities> distinctCommodities() {
		...
		List<String> distinctList = mongo.getCollection("Markets").distinct("commodities.name");
	...
	public RepositoryLinksResource process(RepositoryLinksResource resource) {
		resource.add(linkTo(methodOn(CommoditiesController.class).distinctCommodities()).withRel("commoditiesList"));
		return resource;
	}
